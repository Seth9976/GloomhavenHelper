...
public class ARBGeometryShader4 {
   ...
   public static native void glProgramParameteriARB(@NativeType("GLuint") int var0, @NativeType("GLenum") int var1, @NativeType("GLint") int var2);

   public static native void glFramebufferTextureARB(
      @NativeType("GLenum") int var0, @NativeType("GLenum") int var1, @NativeType("GLuint") int var2, @NativeType("GLint") int var3
   );

   public static native void glFramebufferTextureLayerARB(
   ...
   public static native void glFramebufferTextureFaceARB(
      @NativeType("GLenum") int var0,
      @NativeType("GLenum") int var1,
      @NativeType("GLuint") int var2,
      @NativeType("GLint") int var3,
