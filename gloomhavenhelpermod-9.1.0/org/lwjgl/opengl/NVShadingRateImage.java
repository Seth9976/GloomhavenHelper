...
public class NVShadingRateImage {
   ...
   static boolean isAvailable(GLCapabilities caps) {
      return Checks.checkFunctions(
         caps.glBindShadingRateImageNV,
         caps.glShadingRateImagePaletteNV,
         caps.glGetShadingRateImagePaletteNV,
         caps.glShadingRateImageBarrierNV,
         caps.glShadingRateSampleOrderNV,
         caps.glShadingRateSampleOrderCustomNV,
         caps.glGetShadingRateSampleLocationivNV
      );
   }

   public static native void glBindShadingRateImageNV(@NativeType("GLuint") int var0);

   public static native void nglShadingRateImagePaletteNV(int var0, int var1, int var2, long var3);

   public static void glShadingRateImagePaletteNV(
      @NativeType("GLuint") int viewport, @NativeType("GLuint") int first, @NativeType("GLenum const *") IntBuffer rates
   ) {
      nglShadingRateImagePaletteNV(viewport, first, rates.remaining(), MemoryUtil.memAddress(rates));
   }

   public static native void nglGetShadingRateImagePaletteNV(int var0, int var1, long var2);

   public static void glGetShadingRateImagePaletteNV(
      @NativeType("GLuint") int viewport, @NativeType("GLuint") int entry, @NativeType("GLenum *") IntBuffer rate
   ) {
      if (Checks.CHECKS) {
         Checks.check(rate, 1);
      }

      nglGetShadingRateImagePaletteNV(viewport, entry, MemoryUtil.memAddress(rate));
   }

   public static native void glShadingRateImageBarrierNV(@NativeType("GLboolean") boolean var0);

   public static native void glShadingRateSampleOrderNV(@NativeType("GLenum") int var0);

   public static native void nglShadingRateSampleOrderCustomNV(int var0, int var1, long var2);

   public static void glShadingRateSampleOrderCustomNV(
      @NativeType("GLenum") int rate, @NativeType("GLuint") int samples, @NativeType("GLint const *") IntBuffer locations
   ) {
      nglShadingRateSampleOrderCustomNV(rate, samples, MemoryUtil.memAddress(locations));
   }

   public static native void nglGetShadingRateSampleLocationivNV(int var0, int var1, int var2, long var3);

   public static void glGetShadingRateSampleLocationivNV(
      @NativeType("GLenum") int rate, @NativeType("GLuint") int samples, @NativeType("GLuint") int index, @NativeType("GLint *") IntBuffer location
   ) {
      if (Checks.CHECKS) {
         Checks.check(location, 3);
      }

      nglGetShadingRateSampleLocationivNV(rate, samples, index, MemoryUtil.memAddress(location));
   }

   public static void glShadingRateImagePaletteNV(
      @NativeType("GLuint") int viewport, @NativeType("GLuint") int first, @NativeType("GLenum const *") int[] rates
   ) {
   ...
   public static void glShadingRateSampleOrderCustomNV(
      @NativeType("GLenum") int rate, @NativeType("GLuint") int samples, @NativeType("GLint const *") int[] locations
   ) {
   ...
   public static void glGetShadingRateSampleLocationivNV(
      @NativeType("GLenum") int rate, @NativeType("GLuint") int samples, @NativeType("GLuint") int index, @NativeType("GLint *") int[] location
   ) {
