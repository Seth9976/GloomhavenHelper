...
public class GL42C extends GL41C {
   ...
   public static void glGetActiveAtomicCounterBufferiv(
      @NativeType("GLuint") int program, @NativeType("GLuint") int bufferIndex, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 1);
      }

      nglGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static native void glTexStorage1D(
      @NativeType("GLenum") int var0, @NativeType("GLsizei") int var1, @NativeType("GLenum") int var2, @NativeType("GLsizei") int var3
   );
   ...
   public static native void glDrawTransformFeedbackInstanced(@NativeType("GLenum") int var0, @NativeType("GLuint") int var1, @NativeType("GLsizei") int var2);

   public static native void glDrawTransformFeedbackStreamInstanced(
      @NativeType("GLenum") int var0, @NativeType("GLuint") int var1, @NativeType("GLuint") int var2, @NativeType("GLsizei") int var3
   );

   public static native void glDrawArraysInstancedBaseInstance(
      @NativeType("GLenum") int var0,
   ...
   public static void glDrawElementsInstancedBaseInstance(
      ...
      nglDrawElementsInstancedBaseInstance(
         mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, baseinstance
      );
   }
   ...
   public static void glDrawElementsInstancedBaseInstance(
      ...
      nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, baseinstance);
   }
   ...
   public static void glDrawElementsInstancedBaseInstance(
      ...
      nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, baseinstance);
   }
   ...
   public static void glDrawElementsInstancedBaseInstance(
      ...
      nglDrawElementsInstancedBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, baseinstance);
   }
   ...
   public static void glDrawElementsInstancedBaseVertexBaseInstance(
      ...
      nglDrawElementsInstancedBaseVertexBaseInstance(
         mode, indices.remaining() >> GLChecks.typeToByteShift(type), type, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance
      );
   }
   ...
   public static void glDrawElementsInstancedBaseVertexBaseInstance(
      ...
      nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5121, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
   }
   ...
   public static void glDrawElementsInstancedBaseVertexBaseInstance(
      ...
      nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5123, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
   }
   ...
   public static void glDrawElementsInstancedBaseVertexBaseInstance(
      ...
      nglDrawElementsInstancedBaseVertexBaseInstance(mode, indices.remaining(), 5125, MemoryUtil.memAddress(indices), primcount, basevertex, baseinstance);
   }
   ...
   public static native void glBindImageTexture(
      ...
      @NativeType("GLenum") int var5,
      @NativeType("GLenum") int var6
   );

   public static native void glMemoryBarrier(@NativeType("GLbitfield") int var0);
   ...
   public static void glGetInternalformativ(
      ...
      nglGetInternalformativ(target, internalformat, pname, params.remaining(), MemoryUtil.memAddress(params));
   }
   ...
   public static int glGetInternalformati(@NativeType("GLenum") int target, @NativeType("GLenum") int internalformat, @NativeType("GLenum") int pname) {
      ...
      try {
         IntBuffer params = stack.callocInt(1);
         nglGetInternalformativ(target, internalformat, pname, 1, MemoryUtil.memAddress(params));
         var6 = params.get(0);
      } finally {
         stack.setPointer(stackPointer);
      }
   ...
   public static void glGetActiveAtomicCounterBufferiv(
      @NativeType("GLuint") int program, @NativeType("GLuint") int bufferIndex, @NativeType("GLenum") int pname, @NativeType("GLint *") int[] params
   ) {
