...
public class GL21C extends GL20C {
   ...
   public static void glUniformMatrix2x3fv(
      ...
      nglUniformMatrix2x3fv(location, value.remaining() / 6, transpose, MemoryUtil.memAddress(value));
   }
   ...
   public static void glUniformMatrix3x2fv(
      ...
      nglUniformMatrix3x2fv(location, value.remaining() / 6, transpose, MemoryUtil.memAddress(value));
   }
   ...
   public static void glUniformMatrix2x4fv(
      ...
      nglUniformMatrix2x4fv(location, value.remaining() >> 3, transpose, MemoryUtil.memAddress(value));
   }
   ...
   public static void glUniformMatrix4x2fv(
      ...
      nglUniformMatrix4x2fv(location, value.remaining() >> 3, transpose, MemoryUtil.memAddress(value));
   }
   ...
   public static void glUniformMatrix3x4fv(
      ...
      nglUniformMatrix3x4fv(location, value.remaining() / 12, transpose, MemoryUtil.memAddress(value));
   }
   ...
   public static void glUniformMatrix4x3fv(
      ...
      nglUniformMatrix4x3fv(location, value.remaining() / 12, transpose, MemoryUtil.memAddress(value));
   }
