...
public class AMDPerformanceMonitor {
   ...
   static boolean isAvailable(GLCapabilities caps) {
      return Checks.checkFunctions(
         caps.glGetPerfMonitorGroupsAMD,
         caps.glGetPerfMonitorCountersAMD,
         caps.glGetPerfMonitorGroupStringAMD,
         caps.glGetPerfMonitorCounterStringAMD,
         caps.glGetPerfMonitorCounterInfoAMD,
         caps.glGenPerfMonitorsAMD,
         caps.glDeletePerfMonitorsAMD,
         caps.glSelectPerfMonitorCountersAMD,
         caps.glBeginPerfMonitorAMD,
         caps.glEndPerfMonitorAMD,
         caps.glGetPerfMonitorCounterDataAMD
      );
   }
   ...
   public static void glGetPerfMonitorGroupsAMD(@Nullable @NativeType("GLint *") IntBuffer numGroups, @Nullable @NativeType("GLuint *") IntBuffer groups) {
      ...
      nglGetPerfMonitorGroupsAMD(MemoryUtil.memAddressSafe(numGroups), Checks.remainingSafe(groups), MemoryUtil.memAddressSafe(groups));
   }
   ...
   public static void glGetPerfMonitorCountersAMD(
      ...
      @NativeType("GLint *") IntBuffer numCounters,
      @NativeType("GLint *") IntBuffer maxActiveCounters,
      @NativeType("GLuint *") IntBuffer counters
   ) {
      if (Checks.CHECKS) {
      ...
      nglGetPerfMonitorCountersAMD(
         group, MemoryUtil.memAddress(numCounters), MemoryUtil.memAddress(maxActiveCounters), counters.remaining(), MemoryUtil.memAddress(counters)
      );
   }
   ...
   public static void glGetPerfMonitorGroupStringAMD(
      @NativeType("GLuint") int group, @NativeType("GLsizei *") IntBuffer length, @NativeType("GLchar *") ByteBuffer groupString
   ) {
      if (Checks.CHECKS) {
         Checks.check(length, 1);
      }

      nglGetPerfMonitorGroupStringAMD(group, groupString.remaining(), MemoryUtil.memAddress(length), MemoryUtil.memAddress(groupString));
   }
   ...
   public static void glGetPerfMonitorCounterStringAMD(
      @NativeType("GLuint") int group,
      @NativeType("GLuint") int counter,
      @Nullable @NativeType("GLsizei *") IntBuffer length,
      @Nullable @NativeType("GLchar *") ByteBuffer counterString
   ) {
      if (Checks.CHECKS) {
      ...
      nglGetPerfMonitorCounterStringAMD(
         group, counter, Checks.remainingSafe(counterString), MemoryUtil.memAddressSafe(length), MemoryUtil.memAddressSafe(counterString)
      );
   }
   ...
   public static void glGetPerfMonitorCounterInfoAMD(
      @NativeType("GLuint") int group, @NativeType("GLuint") int counter, @NativeType("GLenum") int pname, @NativeType("void *") ByteBuffer data
   ) {
      if (Checks.CHECKS) {
         Checks.check(data, 4);
      }

      nglGetPerfMonitorCounterInfoAMD(group, counter, pname, MemoryUtil.memAddress(data));
   }

   public static void glGetPerfMonitorCounterInfoAMD(
      @NativeType("GLuint") int group, @NativeType("GLuint") int counter, @NativeType("GLenum") int pname, @NativeType("void *") IntBuffer data
   ) {
      if (Checks.CHECKS) {
         Checks.check(data, 1);
      }
   ...
   public static void glGetPerfMonitorCounterInfoAMD(
      @NativeType("GLuint") int group, @NativeType("GLuint") int counter, @NativeType("GLenum") int pname, @NativeType("void *") FloatBuffer data
   ) {
      if (Checks.CHECKS) {
         Checks.check(data, 1);
      }
   ...
   public static void glGenPerfMonitorsAMD(@NativeType("GLuint *") IntBuffer monitors) {
      nglGenPerfMonitorsAMD(monitors.remaining(), MemoryUtil.memAddress(monitors));
   }
   ...
   public static int glGenPerfMonitorsAMD() {
      ...
      try {
         ...
         nglGenPerfMonitorsAMD(1, MemoryUtil.memAddress(monitors));
         var3 = monitors.get(0);
      } finally {
   ...
   public static void glDeletePerfMonitorsAMD(@NativeType("GLuint *") IntBuffer monitors) {
      nglDeletePerfMonitorsAMD(monitors.remaining(), MemoryUtil.memAddress(monitors));
   }
   ...
   public static void glDeletePerfMonitorsAMD(@NativeType("GLuint *") int monitor) {
      ...
      try {
         ...
         nglDeletePerfMonitorsAMD(1, MemoryUtil.memAddress(monitors));
      } finally {
         stack.setPointer(stackPointer);
      }
   }
   ...
   public static void glSelectPerfMonitorCountersAMD(
      @NativeType("GLuint") int monitor,
      @NativeType("GLboolean") boolean enable,
      @NativeType("GLuint") int group,
      @NativeType("GLuint *") IntBuffer counterList
   ) {
      nglSelectPerfMonitorCountersAMD(monitor, enable, group, counterList.remaining(), MemoryUtil.memAddress(counterList));
   }

   public static native void glBeginPerfMonitorAMD(@NativeType("GLuint") int var0);

   public static native void glEndPerfMonitorAMD(@NativeType("GLuint") int var0);
   ...
   public static void glGetPerfMonitorCounterDataAMD(
      ...
      @NativeType("GLuint *") IntBuffer data,
      @Nullable @NativeType("GLint *") IntBuffer bytesWritten
   ) {
      if (Checks.CHECKS) {
         Checks.checkSafe(bytesWritten, 1);
      }

      nglGetPerfMonitorCounterDataAMD(monitor, pname, data.remaining(), MemoryUtil.memAddress(data), MemoryUtil.memAddressSafe(bytesWritten));
   }
   ...
   public static void glGetPerfMonitorCountersAMD(
      ...
      @NativeType("GLint *") int[] maxActiveCounters,
      @NativeType("GLuint *") int[] counters
   ) {
   ...
   public static void glGetPerfMonitorGroupStringAMD(
      @NativeType("GLuint") int group, @NativeType("GLsizei *") int[] length, @NativeType("GLchar *") ByteBuffer groupString
   ) {
   ...
   public static void glGetPerfMonitorCounterInfoAMD(
      @NativeType("GLuint") int group, @NativeType("GLuint") int counter, @NativeType("GLenum") int pname, @NativeType("void *") int[] data
   ) {
   ...
   public static void glGetPerfMonitorCounterInfoAMD(
      @NativeType("GLuint") int group, @NativeType("GLuint") int counter, @NativeType("GLenum") int pname, @NativeType("void *") float[] data
   ) {
      long __functionAddress = GL.getICD().glGetPerfMonitorCounterInfoAMD;
      if (Checks.CHECKS) {
         Checks.check(__functionAddress);
   ...
   public static void glSelectPerfMonitorCountersAMD(
      @NativeType("GLuint") int monitor, @NativeType("GLboolean") boolean enable, @NativeType("GLuint") int group, @NativeType("GLuint *") int[] counterList
   ) {
   ...
   public static void glGetPerfMonitorCounterDataAMD(
      @NativeType("GLuint") int monitor,
      @NativeType("GLenum") int pname,
      @NativeType("GLuint *") int[] data,
      @Nullable @NativeType("GLint *") int[] bytesWritten
   ) {
