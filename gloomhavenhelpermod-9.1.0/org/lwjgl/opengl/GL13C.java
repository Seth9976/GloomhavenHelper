...
public class GL13C extends GL12C {
   ...
   public static void glCompressedTexImage3D(
      ...
      nglCompressedTexImage3D(target, level, internalformat, width, height, depth, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
   }
   ...
   public static void glCompressedTexImage2D(
      ...
      nglCompressedTexImage2D(target, level, internalformat, width, height, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
   }
   ...
   public static void glCompressedTexImage1D(
      ...
      nglCompressedTexImage1D(target, level, internalformat, width, border, Checks.remainingSafe(data), MemoryUtil.memAddressSafe(data));
   }

   public static native void nglCompressedTexSubImage3D(
   ...
   public static void glCompressedTexSubImage3D(
      ...
      nglCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, data.remaining(), MemoryUtil.memAddress(data));
   }
   ...
   public static void glCompressedTexSubImage2D(
      ...
      nglCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, data.remaining(), MemoryUtil.memAddress(data));
   }
   ...
   public static void glCompressedTexSubImage1D(
      ...
      nglCompressedTexSubImage1D(target, level, xoffset, width, format, data.remaining(), MemoryUtil.memAddress(data));
   }
   ...
   public static void glGetCompressedTexImage(@NativeType("GLenum") int target, @NativeType("GLint") int level, @NativeType("void *") ByteBuffer pixels) {
      ...
      nglGetCompressedTexImage(target, level, MemoryUtil.memAddress(pixels));
   }
   ...
   public static native void glSampleCoverage(@NativeType("GLfloat") float var0, @NativeType("GLboolean") boolean var1);

   public static native void glActiveTexture(@NativeType("GLenum") int var0);
