...
public class GL42 extends GL41 {
   ...
   static boolean isAvailable(GLCapabilities caps) {
      return Checks.checkFunctions(
         ...
         caps.glTexStorage2D,
         caps.glTexStorage3D,
         caps.glDrawTransformFeedbackInstanced,
         caps.glDrawTransformFeedbackStreamInstanced,
         caps.glDrawArraysInstancedBaseInstance,
         caps.glDrawElementsInstancedBaseInstance,
         caps.glDrawElementsInstancedBaseVertexBaseInstance,
         caps.glBindImageTexture,
         caps.glMemoryBarrier,
   ...
   public static void glBindImageTexture(
      @NativeType("GLuint") int unit,
      @NativeType("GLuint") int texture,
      @NativeType("GLint") int level,
      @NativeType("GLboolean") boolean layered,
