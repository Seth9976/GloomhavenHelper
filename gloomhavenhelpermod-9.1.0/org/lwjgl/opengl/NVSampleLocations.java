...
public class NVSampleLocations {
   ...
   public static void glFramebufferSampleLocationsfvNV(
      ...
      nglFramebufferSampleLocationsfvNV(target, start, v.remaining() >> 1, MemoryUtil.memAddress(v));
   }
   ...
   public static void glNamedFramebufferSampleLocationsfvNV(
      ...
      nglNamedFramebufferSampleLocationsfvNV(framebuffer, start, v.remaining() >> 1, MemoryUtil.memAddress(v));
   }
