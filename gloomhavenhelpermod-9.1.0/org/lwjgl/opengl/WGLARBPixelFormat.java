...
public class WGLARBPixelFormat {
   ...
   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribivARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") IntBuffer attributes, @NativeType("int *") IntBuffer values
   ) {
      if (Checks.CHECKS) {
         Checks.check(values, attributes.remaining());
      }

      return nwglGetPixelFormatAttribivARB(
            hdc, pixelFormat, layerPlane, attributes.remaining(), MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values)
         )
         != 0;
   }

   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribiARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") int attribute, @NativeType("int *") IntBuffer values
   ) {
      if (Checks.CHECKS) {
      ...
      try {
         ...
         var9 = nwglGetPixelFormatAttribivARB(hdc, pixelFormat, layerPlane, 1, MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values)) != 0;
      } finally {
   ...
   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribfvARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") IntBuffer attributes, @NativeType("FLOAT *") FloatBuffer values
   ) {
      if (Checks.CHECKS) {
         Checks.check(values, attributes.remaining());
      }

      return nwglGetPixelFormatAttribfvARB(
            hdc, pixelFormat, layerPlane, attributes.remaining(), MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values)
         )
         != 0;
   }
   ...
   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribfARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") int attribute, @NativeType("FLOAT *") FloatBuffer values
   ) {
      if (Checks.CHECKS) {
         Checks.check(values, 1);
      }
      ...
      try {
         IntBuffer attributes = stack.ints(attribute);
         var9 = nwglGetPixelFormatAttribfvARB(hdc, pixelFormat, layerPlane, 1, MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values)) != 0;
      } finally {
         stack.setPointer(stackPointer);
      }
   ...
   public static boolean wglChoosePixelFormatARB(
      @NativeType("HDC") long hdc,
      @Nullable @NativeType("int const *") IntBuffer attribIList,
      @Nullable @NativeType("FLOAT const *") FloatBuffer attribFList,
      @NativeType("int *") IntBuffer formats,
      @NativeType("UINT *") IntBuffer numFormats
   ) {
      if (Checks.CHECKS) {
      ...
      return nwglChoosePixelFormatARB(
            hdc,
            MemoryUtil.memAddressSafe(attribIList),
            MemoryUtil.memAddressSafe(attribFList),
            formats.remaining(),
            MemoryUtil.memAddress(formats),
            MemoryUtil.memAddress(numFormats)
         )
         != 0;
   }
   ...
   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribivARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") int[] attributes, @NativeType("int *") int[] values
   ) {
      long __functionAddress = GL.getCapabilitiesWGL().wglGetPixelFormatAttribivARB;
      if (Checks.CHECKS) {
         Checks.check(__functionAddress);
   ...
   @NativeType("BOOL")
   public static boolean wglGetPixelFormatAttribfvARB(
      @NativeType("HDC") long hdc, int pixelFormat, int layerPlane, @NativeType("int const *") int[] attributes, @NativeType("FLOAT *") float[] values
   ) {
      long __functionAddress = GL.getCapabilitiesWGL().wglGetPixelFormatAttribfvARB;
      if (Checks.CHECKS) {
         Checks.check(__functionAddress);
   ...
   public static boolean wglChoosePixelFormatARB(
      @NativeType("HDC") long hdc,
      @Nullable @NativeType("int const *") int[] attribIList,
      @Nullable @NativeType("FLOAT const *") float[] attribFList,
      @NativeType("int *") int[] formats,
      @NativeType("UINT *") int[] numFormats
   ) {
      long __functionAddress = GL.getCapabilitiesWGL().wglChoosePixelFormatARB;
      if (Checks.CHECKS) {
         Checks.check(__functionAddress);
