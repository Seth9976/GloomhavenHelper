...
public class ARBImaging {
      ...
      return (
            fc
               || Checks.checkFunctions(
                  caps.glColorTable,
                  caps.glCopyColorTable,
                  caps.glColorTableParameteriv,
                  caps.glColorTableParameterfv,
                  caps.glGetColorTable,
                  caps.glGetColorTableParameteriv,
                  caps.glGetColorTableParameterfv,
                  caps.glColorSubTable,
                  caps.glCopyColorSubTable,
                  caps.glConvolutionFilter1D,
                  caps.glConvolutionFilter2D,
                  caps.glCopyConvolutionFilter1D,
                  caps.glCopyConvolutionFilter2D,
                  caps.glGetConvolutionFilter,
                  caps.glSeparableFilter2D,
                  caps.glGetSeparableFilter,
                  caps.glConvolutionParameteri,
                  caps.glConvolutionParameteriv,
                  caps.glConvolutionParameterf,
                  caps.glConvolutionParameterfv,
                  caps.glGetConvolutionParameteriv,
                  caps.glGetConvolutionParameterfv,
                  caps.glHistogram,
                  caps.glResetHistogram,
                  caps.glGetHistogram,
                  caps.glGetHistogramParameteriv,
                  caps.glGetHistogramParameterfv,
                  caps.glMinmax,
                  caps.glResetMinmax,
                  caps.glGetMinmax,
                  caps.glGetMinmaxParameteriv,
                  caps.glGetMinmaxParameterfv
               )
         )
         && Checks.checkFunctions(caps.glBlendColor, caps.glBlendEquation);
   }
   ...
   public static void glColorTable(
      ...
      @NativeType("void const *") ByteBuffer table
   ) {
      nglColorTable(target, internalformat, width, format, type, MemoryUtil.memAddress(table));
   }
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") long table
   ) {
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") ShortBuffer table
   ) {
      nglColorTable(target, internalformat, width, format, type, MemoryUtil.memAddress(table));
   }
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") IntBuffer table
   ) {
      nglColorTable(target, internalformat, width, format, type, MemoryUtil.memAddress(table));
   }
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") FloatBuffer table
   ) {
      nglColorTable(target, internalformat, width, format, type, MemoryUtil.memAddress(table));
   }

   public static native void glCopyColorTable(
   ...
   public static void glColorTableParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint const *") IntBuffer params) {
      ...
      nglColorTableParameteriv(target, pname, MemoryUtil.memAddress(params));
   }

   public static native void nglColorTableParameterfv(int var0, int var1, long var2);

   public static void glColorTableParameterfv(
      @NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLfloat const *") FloatBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 4);
      }

      nglColorTableParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetColorTable(
      ...
      nglGetColorTable(target, format, type, MemoryUtil.memAddress(table));
   }

   public static void glGetColorTable(
      @NativeType("GLenum") int target, @NativeType("GLenum") int format, @NativeType("GLenum") int type, @NativeType("void *") long table
   ) {
   ...
   public static void glGetColorTableParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params) {
      ...
      nglGetColorTableParameteriv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetColorTableParameterfv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLfloat *") FloatBuffer params) {
      ...
      nglGetColorTableParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glColorSubTable(
      ...
      nglColorSubTable(target, start, count, format, type, MemoryUtil.memAddress(data));
   }
   ...
   public static native void glCopyColorSubTable(
      @NativeType("GLenum") int var0,
   ...
   public static void glConvolutionFilter1D(
      ...
      nglConvolutionFilter1D(target, internalformat, width, format, type, MemoryUtil.memAddress(data));
   }
   ...
   public static void glConvolutionFilter2D(
      ...
      nglConvolutionFilter2D(target, internalformat, width, height, format, type, MemoryUtil.memAddress(data));
   }
   ...
   public static native void glCopyConvolutionFilter1D(
      @NativeType("GLenum") int var0,
      @NativeType("GLenum") int var1,
      @NativeType("GLint") int var2,
      @NativeType("GLint") int var3,
   ...
   public static native void glCopyConvolutionFilter2D(
      @NativeType("GLenum") int var0,
      @NativeType("GLenum") int var1,
      @NativeType("GLint") int var2,
      @NativeType("GLint") int var3,
   ...
   public static void glGetConvolutionFilter(
      ...
      nglGetConvolutionFilter(target, format, type, MemoryUtil.memAddress(image));
   }

   public static void glGetConvolutionFilter(
      @NativeType("GLenum") int target, @NativeType("GLenum") int format, @NativeType("GLenum") int type, @NativeType("void *") long image
   ) {
   ...
   public static void glSeparableFilter2D(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") ByteBuffer row,
      @NativeType("void const *") ByteBuffer column
   ) {
      nglSeparableFilter2D(target, internalformat, width, height, format, type, MemoryUtil.memAddress(row), MemoryUtil.memAddress(column));
   }
   ...
   public static void glSeparableFilter2D(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") long row,
      @NativeType("void const *") long column
   ) {
   ...
   public static void glGetSeparableFilter(
      ...
      nglGetSeparableFilter(target, format, type, MemoryUtil.memAddress(row), MemoryUtil.memAddress(column), MemoryUtil.memAddressSafe(span));
   }
   ...
   public static void glGetSeparableFilter(
      ...
      nglGetSeparableFilter(target, format, type, row, column, MemoryUtil.memAddressSafe(span));
   }

   public static native void glConvolutionParameteri(@NativeType("GLenum") int var0, @NativeType("GLenum") int var1, @NativeType("GLint") int var2);
   ...
   public static void glConvolutionParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint const *") IntBuffer params) {
      ...
      nglConvolutionParameteriv(target, pname, MemoryUtil.memAddress(params));
   }

   public static native void glConvolutionParameterf(@NativeType("GLenum") int var0, @NativeType("GLenum") int var1, @NativeType("GLfloat") float var2);
   ...
   public static void glConvolutionParameterfv(
      ...
      nglConvolutionParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetConvolutionParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params) {
      ...
      nglGetConvolutionParameteriv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetConvolutionParameterfv(
      @NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLfloat *") FloatBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 4);
      }

      nglGetConvolutionParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static native void glHistogram(
      @NativeType("GLenum") int var0, @NativeType("GLsizei") int var1, @NativeType("GLenum") int var2, @NativeType("GLboolean") boolean var3
   );

   public static native void glResetHistogram(@NativeType("GLenum") int var0);
   ...
   public static void glGetHistogram(
      ...
      nglGetHistogram(target, reset, format, type, MemoryUtil.memAddress(values));
   }
   ...
   public static void glGetHistogramParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params) {
      ...
      nglGetHistogramParameteriv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetHistogramParameterfv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLfloat *") FloatBuffer params) {
      ...
      nglGetHistogramParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static native void glMinmax(@NativeType("GLenum") int var0, @NativeType("GLenum") int var1, @NativeType("GLboolean") boolean var2);

   public static native void glResetMinmax(@NativeType("GLenum") int var0);
   ...
   public static void glGetMinmax(
      ...
      nglGetMinmax(target, reset, format, type, MemoryUtil.memAddress(values));
   }
   ...
   public static void glGetMinmaxParameteriv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params) {
      ...
      nglGetMinmaxParameteriv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetMinmaxParameterfv(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLfloat *") FloatBuffer params) {
      ...
      nglGetMinmaxParameterfv(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") short[] table
   ) {
   ...
   public static void glColorTable(
      ...
      @NativeType("GLenum") int format,
      @NativeType("GLenum") int type,
      @NativeType("void const *") int[] table
   ) {
      long __functionAddress = GL.getICD().glColorTable;
      if (Checks.CHECKS) {
         Checks.check(__functionAddress);
