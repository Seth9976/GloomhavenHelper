...
public class ARBVertexProgram {
   ...
   static boolean isAvailable(GLCapabilities caps) {
      return Checks.checkFunctions(
         ...
         caps.glProgramStringARB,
         caps.glBindProgramARB,
         caps.glDeleteProgramsARB,
         caps.glGenProgramsARB,
         caps.glProgramEnvParameter4dARB,
         caps.glProgramEnvParameter4dvARB,
         caps.glProgramEnvParameter4fARB,
         caps.glProgramEnvParameter4fvARB,
         caps.glProgramLocalParameter4dARB,
         caps.glProgramLocalParameter4dvARB,
         caps.glProgramLocalParameter4fARB,
         caps.glProgramLocalParameter4fvARB,
         caps.glGetProgramEnvParameterfvARB,
         caps.glGetProgramEnvParameterdvARB,
         caps.glGetProgramLocalParameterfvARB,
         caps.glGetProgramLocalParameterdvARB,
         caps.glGetProgramivARB,
         caps.glGetProgramStringARB,
   ...
   public static void glProgramStringARB(@NativeType("GLenum") int target, @NativeType("GLenum") int format, @NativeType("void const *") ByteBuffer string) {
      nglProgramStringARB(target, format, string.remaining(), MemoryUtil.memAddress(string));
   }

   public static native void glBindProgramARB(@NativeType("GLenum") int var0, @NativeType("GLuint") int var1);
   ...
   public static void glDeleteProgramsARB(@NativeType("GLuint const *") IntBuffer programs) {
      nglDeleteProgramsARB(programs.remaining(), MemoryUtil.memAddress(programs));
   }
   ...
   public static void glGenProgramsARB(@NativeType("GLuint *") IntBuffer programs) {
      nglGenProgramsARB(programs.remaining(), MemoryUtil.memAddress(programs));
   }
   ...
   public static int glGenProgramsARB() {
      ...
      try {
         ...
         nglGenProgramsARB(1, MemoryUtil.memAddress(programs));
         var3 = programs.get(0);
      } finally {
   ...
   public static void glProgramEnvParameter4dvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLdouble const *") DoubleBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 4);
      }

      nglProgramEnvParameter4dvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glProgramEnvParameter4fvARB(
      ...
      nglProgramEnvParameter4fvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glProgramLocalParameter4dvARB(
      ...
      nglProgramLocalParameter4dvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glProgramLocalParameter4fvARB(
      ...
      nglProgramLocalParameter4fvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramEnvParameterfvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLfloat *") FloatBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 4);
      }

      nglGetProgramEnvParameterfvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramEnvParameterdvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLdouble *") DoubleBuffer params
   ) {
      if (Checks.CHECKS) {
         Checks.check(params, 4);
      }

      nglGetProgramEnvParameterdvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramLocalParameterfvARB(
      ...
      nglGetProgramLocalParameterfvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramLocalParameterdvARB(
      ...
      nglGetProgramLocalParameterdvARB(target, index, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramivARB(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("GLint *") IntBuffer params) {
      ...
      nglGetProgramivARB(target, pname, MemoryUtil.memAddress(params));
   }
   ...
   public static void glGetProgramStringARB(@NativeType("GLenum") int target, @NativeType("GLenum") int pname, @NativeType("void *") ByteBuffer string) {
      if (Checks.CHECKS && Checks.DEBUG) {
         Checks.check(string, glGetProgramiARB(target, 34343));
      }

      nglGetProgramStringARB(target, pname, MemoryUtil.memAddress(string));
   }
   ...
   public static native boolean glIsProgramARB(@NativeType("GLuint") int var0);
   ...
   public static void glProgramEnvParameter4dvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLdouble const *") double[] params
   ) {
   ...
   public static void glGetProgramEnvParameterdvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLdouble *") double[] params
   ) {
   ...
   public static void glGetProgramLocalParameterfvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int index, @NativeType("GLfloat *") float[] params
   ) {
