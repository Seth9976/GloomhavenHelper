...
public class NVMeshShader {
   ...
   public static native void glDrawMeshTasksNV(@NativeType("GLuint") int var0, @NativeType("GLuint") int var1);

   public static native void glDrawMeshTasksIndirectNV(@NativeType("GLintptr") long var0);

   public static native void glMultiDrawMeshTasksIndirectNV(@NativeType("GLintptr") long var0, @NativeType("GLsizei") int var2, @NativeType("GLsizei") int var3);

   public static native void glMultiDrawMeshTasksIndirectCountNV(
      @NativeType("GLintptr") long var0, @NativeType("GLintptr") long var2, @NativeType("GLsizei") int var4, @NativeType("GLsizei") int var5
   );
