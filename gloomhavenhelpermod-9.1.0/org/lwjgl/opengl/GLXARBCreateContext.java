...
public class GLXARBCreateContext {
   ...
   public static long glXCreateContextAttribsARB(
      @NativeType("Display *") long display,
      @NativeType("GLXFBConfig") long config,
      @NativeType("GLXContext") long share_context,
      ...
      return nglXCreateContextAttribsARB(display, config, share_context, direct ? 1 : 0, MemoryUtil.memAddressSafe(attrib_list));
   }
