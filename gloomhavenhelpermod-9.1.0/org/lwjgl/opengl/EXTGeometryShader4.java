...
public class EXTGeometryShader4 {
   ...
   public static native void glProgramParameteriEXT(@NativeType("GLuint") int var0, @NativeType("GLenum") int var1, @NativeType("GLint") int var2);
   ...
   public static native void glFramebufferTextureFaceEXT(
