...
public class ARBSampleLocations {
   ...
   public static void glFramebufferSampleLocationsfvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int start, @NativeType("GLfloat const *") FloatBuffer v
   ) {
      nglFramebufferSampleLocationsfvARB(target, start, v.remaining() >> 1, MemoryUtil.memAddress(v));
   }
   ...
   public static void glNamedFramebufferSampleLocationsfvARB(
      @NativeType("GLuint") int framebuffer, @NativeType("GLuint") int start, @NativeType("GLfloat const *") FloatBuffer v
   ) {
      nglNamedFramebufferSampleLocationsfvARB(framebuffer, start, v.remaining() >> 1, MemoryUtil.memAddress(v));
   }

   public static native void glEvaluateDepthValuesARB();

   public static void glFramebufferSampleLocationsfvARB(
      @NativeType("GLenum") int target, @NativeType("GLuint") int start, @NativeType("GLfloat const *") float[] v
   ) {
   ...
   public static void glNamedFramebufferSampleLocationsfvARB(
      @NativeType("GLuint") int framebuffer, @NativeType("GLuint") int start, @NativeType("GLfloat const *") float[] v
   ) {
