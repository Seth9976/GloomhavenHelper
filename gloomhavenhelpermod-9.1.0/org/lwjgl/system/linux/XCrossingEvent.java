...
public class XCrossingEvent extends Struct implements NativeResource {
   ...
   public int same_screen() {
      return nsame_screen(this.address());
   }

   public int focus() {
      return nfocus(this.address());
   }
   ...
   public XCrossingEvent same_screen(int value) {
      nsame_screen(this.address(), value);
      return this;
   }

   public XCrossingEvent focus(int value) {
      nfocus(this.address(), value);
      return this;
   }
   ...
   public static XCrossingEvent.Buffer malloc(int capacity) {
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, MemoryUtil.nmemAllocChecked(__checkMalloc(capacity, SIZEOF)), capacity);
   }

   public static XCrossingEvent.Buffer calloc(int capacity) {
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, MemoryUtil.nmemCallocChecked(capacity, SIZEOF), capacity);
   }

   public static XCrossingEvent.Buffer create(int capacity) {
      ByteBuffer container = __create(capacity, SIZEOF);
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, MemoryUtil.memAddress(container), capacity, container);
   }

   public static XCrossingEvent.Buffer create(long address, int capacity) {
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, address, capacity);
   }

   @Nullable
   public static XCrossingEvent.Buffer createSafe(long address, int capacity) {
      return address == 0L ? null : (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, address, capacity);
   }
   ...
   public static XCrossingEvent.Buffer mallocStack(int capacity, MemoryStack stack) {
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, stack.nmalloc(ALIGNOF, capacity * SIZEOF), capacity);
   }

   public static XCrossingEvent.Buffer callocStack(int capacity, MemoryStack stack) {
      return (XCrossingEvent.Buffer)wrap(XCrossingEvent.Buffer.class, stack.ncalloc(ALIGNOF, capacity, SIZEOF), capacity);
   }
   ...
   public static int nfocus(long struct) {
      return UNSAFE.getInt(null, struct + FOCUS);
   }
   ...
   public static void nfocus(long struct, int value) {
      UNSAFE.putInt(null, struct + FOCUS, value);
   }
   ...
   public static class Buffer extends StructBuffer implements NativeResource {
      ...
      public Buffer(ByteBuffer container) {
         super(container, container.remaining() / XCrossingEvent.SIZEOF);
      }
      ...
      protected XCrossingEvent.Buffer self() {
         return this;
      }
      ...
      public XCrossingEvent.Buffer type(int value) {
         XCrossingEvent.ntype(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer serial(@NativeType("unsigned long") long value) {
         XCrossingEvent.nserial(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer send_event(@NativeType("Bool") boolean value) {
         XCrossingEvent.nsend_event(this.address(), value ? 1 : 0);
         return this;
      }

      public XCrossingEvent.Buffer display(@NativeType("Display *") long value) {
         XCrossingEvent.ndisplay(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer window(@NativeType("Window") long value) {
         XCrossingEvent.nwindow(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer root(@NativeType("Window") long value) {
         XCrossingEvent.nroot(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer subwindow(@NativeType("Window") long value) {
         XCrossingEvent.nsubwindow(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer time(@NativeType("Time") long value) {
         XCrossingEvent.ntime(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer x(int value) {
         XCrossingEvent.nx(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer y(int value) {
         XCrossingEvent.ny(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer x_root(int value) {
         XCrossingEvent.nx_root(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer y_root(int value) {
         XCrossingEvent.ny_root(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer mode(int value) {
         XCrossingEvent.nmode(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer detail(int value) {
         XCrossingEvent.ndetail(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer same_screen(int value) {
         XCrossingEvent.nsame_screen(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer focus(int value) {
         XCrossingEvent.nfocus(this.address(), value);
         return this;
      }

      public XCrossingEvent.Buffer state(@NativeType("unsigned int") int value) {
