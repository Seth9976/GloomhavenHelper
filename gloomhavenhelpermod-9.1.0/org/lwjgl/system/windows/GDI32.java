...
public class GDI32 {
   ...
   public static int nChoosePixelFormat(long hdc, long pixelFormatDescriptor) {
      long __functionAddress = GDI32.Functions.ChoosePixelFormat;
      if (Checks.CHECKS) {
         Checks.check(hdc);
      }
   ...
   public static int nDescribePixelFormat(long hdc, int pixelFormat, int bytes, long pixelFormatDescriptor) {
      long __functionAddress = GDI32.Functions.DescribePixelFormat;
      if (Checks.CHECKS) {
         Checks.check(hdc);
      }
   ...
   public static int DescribePixelFormat(
      @NativeType("HDC") long hdc,
      int pixelFormat,
      @NativeType("UINT") int bytes,
      @Nullable @NativeType("LPPIXELFORMATDESCRIPTOR") PIXELFORMATDESCRIPTOR pixelFormatDescriptor
   ) {
      return nDescribePixelFormat(hdc, pixelFormat, bytes, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
   }

   public static int DescribePixelFormat(
      @NativeType("HDC") long hdc, int pixelFormat, @Nullable @NativeType("LPPIXELFORMATDESCRIPTOR") PIXELFORMATDESCRIPTOR pixelFormatDescriptor
   ) {
      return nDescribePixelFormat(hdc, pixelFormat, PIXELFORMATDESCRIPTOR.SIZEOF, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
   }

   public static native int nGetPixelFormat(long var0, long var2);

   public static int GetPixelFormat(@NativeType("HDC") long hdc) {
      long __functionAddress = GDI32.Functions.GetPixelFormat;
      if (Checks.CHECKS) {
         Checks.check(hdc);
      }
   ...
   public static int nSetPixelFormat(long hdc, int pixelFormat, long pixelFormatDescriptor) {
      long __functionAddress = GDI32.Functions.SetPixelFormat;
      if (Checks.CHECKS) {
         Checks.check(hdc);
      }
   ...
   @NativeType("BOOL")
   public static boolean SetPixelFormat(
      @NativeType("HDC") long hdc, int pixelFormat, @Nullable @NativeType("PIXELFORMATDESCRIPTOR const *") PIXELFORMATDESCRIPTOR pixelFormatDescriptor
   ) {
      return nSetPixelFormat(hdc, pixelFormat, MemoryUtil.memAddressSafe(pixelFormatDescriptor)) != 0;
   }
   ...
   public static boolean SwapBuffers(@NativeType("HDC") long dc) {
      long __functionAddress = GDI32.Functions.SwapBuffers;
      if (Checks.CHECKS) {
         Checks.check(dc);
      }
   ...
   public static final class Functions {
      public static final long ChoosePixelFormat = APIUtil.apiGetFunctionAddress(org.lwjgl.system.windows.GDI32.GDI32, "ChoosePixelFormat");
      public static final long DescribePixelFormat = APIUtil.apiGetFunctionAddress(org.lwjgl.system.windows.GDI32.GDI32, "DescribePixelFormat");
      public static final long GetPixelFormat = APIUtil.apiGetFunctionAddress(org.lwjgl.system.windows.GDI32.GDI32, "GetPixelFormat");
      public static final long SetPixelFormat = APIUtil.apiGetFunctionAddress(org.lwjgl.system.windows.GDI32.GDI32, "SetPixelFormat");
      public static final long SwapBuffers = APIUtil.apiGetFunctionAddress(org.lwjgl.system.windows.GDI32.GDI32, "SwapBuffers");
