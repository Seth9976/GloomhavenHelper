      ...
      this.detector = new GestureDetector(
         ...
         new GestureDetector.GestureAdapter() {
            ...
            public boolean pan(float stageX, float stageY, float deltaX, float deltaY) {
               ...
               ActorGestureListener.this.actor.stageToLocalCoordinates(ActorGestureListener.tmpCoords.set(stageX, stageY));
               ActorGestureListener.this.pan(
                  ActorGestureListener.this.event, ActorGestureListener.tmpCoords.x, ActorGestureListener.tmpCoords.y, deltaX, deltaY
               );
               return true;
            }
            ...
            public boolean panStop(float stageX, float stageY, int pointer, int button) {
               ...
               ActorGestureListener.this.panStop(
                  ActorGestureListener.this.event, ActorGestureListener.tmpCoords.x, ActorGestureListener.tmpCoords.y, pointer, button
               );
               return true;
            }
