      ...
      if (!(e instanceof InputEvent)) {
         ...
         switch (event.getType()) {
            ...
            default:
               ...
               switch (event.getType()) {
                  case touchDown:
                     boolean handled = this.touchDown(event, tmpCoords.x, tmpCoords.y, event.getPointer(), event.getButton());
                  ...
                  case scrolled:
                     return this.scrolled(event, tmpCoords.x, tmpCoords.y, event.getScrollAmountX(), event.getScrollAmountY());
                  case enter:
