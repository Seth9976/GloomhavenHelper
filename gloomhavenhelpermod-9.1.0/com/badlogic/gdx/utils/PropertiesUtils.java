...
public final class PropertiesUtils {
   ...
   public static void load(ObjectMap properties, Reader reader) throws IOException {
      if (properties == null) {
   ...
   public static void store(ObjectMap properties, Writer writer, String comment) throws IOException {
      storeImpl(properties, writer, comment, false);
   }

   private static void storeImpl(ObjectMap properties, Writer writer, String comment, boolean escapeUnicode) throws IOException {
      if (comment != null) {
