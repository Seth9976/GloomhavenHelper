...
public class QuickSelect {
   ...
   public int select(Object[] items, Comparator comp, int n, int size) {
      this.array = items;
      this.comp = comp;
   ...
   private int partition(int left, int right, int pivot) {
      Object pivotValue = (T)this.array[pivot];
   ...
   private int medianOfThreePivot(int leftIdx, int rightIdx) {
      Object left = (T)this.array[leftIdx];
      int midIdx = (leftIdx + rightIdx) / 2;
      Object mid = (T)this.array[midIdx];
      Object right = (T)this.array[rightIdx];
