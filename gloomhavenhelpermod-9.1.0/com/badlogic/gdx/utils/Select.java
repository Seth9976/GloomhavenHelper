...
public class Select {
   ...
   public Object select(Object[] items, Comparator comp, int kthLowest, int size) {
      int idx = this.selectIndex(items, comp, kthLowest, size);
      return items[idx];
   }

   public int selectIndex(Object[] items, Comparator comp, int kthLowest, int size) {
      if (size < 1) {
   ...
   private int fastMin(Object[] items, Comparator comp, int size) {
      int lowestIdx = 0;
   ...
   private int fastMax(Object[] items, Comparator comp, int size) {
      int highestIdx = 0;
