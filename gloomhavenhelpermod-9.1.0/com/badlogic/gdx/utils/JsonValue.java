...
public class JsonValue implements Iterable {
   ...
   public float getFloat(String name, float defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asFloat() : defaultValue;
   }

   public double getDouble(String name, double defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asDouble() : defaultValue;
   }

   public long getLong(String name, long defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asLong() : defaultValue;
   }

   public int getInt(String name, int defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asInt() : defaultValue;
   }

   public boolean getBoolean(String name, boolean defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asBoolean() : defaultValue;
   }

   public byte getByte(String name, byte defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asByte() : defaultValue;
   }

   public short getShort(String name, short defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asShort() : defaultValue;
   }

   public char getChar(String name, char defaultValue) {
      JsonValue child = this.get(name);
      return child != null && child.isValue() && !child.isNull() ? child.asChar() : defaultValue;
   }
   ...
   private void prettyPrint(JsonValue object, Writer writer, int indent, JsonValue.PrettyPrintSettings settings) throws IOException {
      JsonWriter.OutputType outputType = settings.outputType;
      if (object.isObject()) {
         if (object.child == null) {
            writer.append("{}");
   ...
   public class JsonIterator implements Iterator, Iterable {
