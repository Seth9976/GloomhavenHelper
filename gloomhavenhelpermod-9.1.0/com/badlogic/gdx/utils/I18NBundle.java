...
public class I18NBundle {
   ...
   private static I18NBundle createBundleImpl(FileHandle baseFileHandle, Locale locale, String encoding) {
      if (baseFileHandle != null && locale != null && encoding != null) {
         ...
         do {
            List candidateLocales = getCandidateLocales(targetLocale);
   ...
   private static I18NBundle loadBundleChain(FileHandle baseFileHandle, String encoding, List candidateLocales, int candidateIndex, I18NBundle baseBundle) {
