...
public final class ClassReflection {
   ...
   public static Object newInstance(Class c) throws ReflectionException {
      try {
   ...
   public static boolean isAnnotationPresent(Class c, Class annotationType) {
   ...
   public static Annotation getAnnotation(Class c, Class annotationType) {
   ...
   public static Annotation getDeclaredAnnotation(Class c, Class annotationType) {
      java.lang.annotation.Annotation[] annotations = c.getDeclaredAnnotations();
