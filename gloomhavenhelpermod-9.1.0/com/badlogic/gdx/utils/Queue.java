...
public class Queue implements Iterable {
   ...
   public void addLast(@Null Object object) {
      Object[] values = (T[])this.values;
   ...
   public void addFirst(@Null Object object) {
      Object[] values = (T[])this.values;
      if (this.size == values.length) {
         this.resize(values.length << 1);
         values = (T[])this.values;
   ...
   protected void resize(int newSize) {
      ...
      int head = this.head;
      int tail = this.tail;
      Object[] newArray = (T[])((Object[])ArrayReflection.newInstance(values.getClass().getComponentType(), newSize));
      if (head < tail) {
   ...
   public Object removeFirst() {
      if (this.size == 0) {
         ...
         Object[] values = (T[])this.values;
         Object result = values[this.head];
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         if (q.size != size) {
            ...
            for (int s = 0; s < size; s++) {
               Object myValue = myValues[myIndex];
   ...
   public static class QueueIterable implements Iterable {
      ...
      public QueueIterable(Queue queue, boolean allowRemove) {
         this.queue = queue;
   ...
   public static class QueueIterator implements Iterator, Iterable {
      private final Queue queue;
      private final boolean allowRemove;
      int index;
      boolean valid = true;
      ...
      public QueueIterator(Queue queue, boolean allowRemove) {
         this.queue = queue;
         this.allowRemove = allowRemove;
      }
