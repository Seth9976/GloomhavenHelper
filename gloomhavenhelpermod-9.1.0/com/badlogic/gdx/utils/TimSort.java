...
class TimSort {
   ...
   public void doSort(Object[] a, Comparator c, int lo, int hi) {
      this.stackSize = 0;
   ...
   private TimSort(Object[] a, Comparator c) {
      ...
      this.c = c;
      int len = a.length;
      Object[] newArray = (T[])((Object[])(new Object[len < 512 ? len >>> 1 : 256]));
      this.tmp = newArray;
   ...
   static void sort(Object[] a, int lo, int hi, Comparator c) {
      if (c == null) {
         Arrays.sort(a, lo, hi);
      } else {
         rangeCheck(a.length, lo, hi);
   ...
   private void mergeLo(int base1, int len1, int base2, int len2) {
      Object[] a = (T[])this.a;
      Object[] tmp = (T[])this.ensureCapacity(len1);
   ...
   private void mergeHi(int base1, int len1, int base2, int len2) {
      Object[] a = (T[])this.a;
      Object[] tmp = (T[])this.ensureCapacity(len2);
   ...
   private Object[] ensureCapacity(int minCapacity) {
      ...
      if (this.tmp.length < minCapacity) {
         ...
         Object[] newArray = (T[])((Object[])(new Object[newSize]));
         this.tmp = newArray;
      }
