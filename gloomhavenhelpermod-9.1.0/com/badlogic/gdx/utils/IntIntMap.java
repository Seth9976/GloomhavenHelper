...
public class IntIntMap implements Iterable {
   ...
   public static class Entries extends IntIntMap.MapIterator implements Iterable, Iterator {
      private final IntIntMap.Entry entry = new IntIntMap.Entry();
   ...
   public static class Values extends IntIntMap.MapIterator {
      ...
      public IntIntMap.Values iterator() {
         return this;
      }
