...
public class TideMapLoader extends SynchronousAssetLoader {
   ...
   public Array getDependencies(String fileName, FileHandle tmxFile, TideMapLoader.Parameters parameter) {
   ...
   private Array loadTileSheets(XmlReader.Element root, FileHandle tideFile) throws IOException {
   ...
   private void loadLayer(TiledMap map, XmlReader.Element element) {
      if (element.getName().equals("Layer")) {
         ...
         Array rows = tileArray.getChildrenByName("Row");
         TiledMapTileSets tilesets = map.getTileSets();
