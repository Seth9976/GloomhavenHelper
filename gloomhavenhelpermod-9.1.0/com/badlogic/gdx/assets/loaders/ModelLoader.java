...
public abstract class ModelLoader extends AsynchronousAssetLoader {
   ...
   public abstract ModelData loadModelData(FileHandle var1, ModelLoader.ModelParameters var2);

   public ModelData loadModelData(FileHandle fileHandle) {
      return this.loadModelData(fileHandle, null);
   }

   public Model loadModel(FileHandle fileHandle, TextureProvider textureProvider, ModelLoader.ModelParameters parameters) {
      ModelData data = this.loadModelData(fileHandle, parameters);
      return data == null ? null : new Model(data, textureProvider);
   }

   public Model loadModel(FileHandle fileHandle, ModelLoader.ModelParameters parameters) {
   ...
   public Array getDependencies(String fileName, FileHandle file, ModelLoader.ModelParameters parameters) {
   ...
   public void loadAsync(AssetManager manager, String fileName, FileHandle file, ModelLoader.ModelParameters parameters) {
   }
