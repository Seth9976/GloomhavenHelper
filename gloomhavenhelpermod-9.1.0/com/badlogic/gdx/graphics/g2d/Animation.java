...
public class Animation {
   ...
   public Animation(float frameDuration, Array keyFrames) {
      ...
      Object[] frames = (T[])((Object[])ArrayReflection.newInstance(arrayType, keyFrames.size));
      int i = 0;
   ...
   public Animation(float frameDuration, Array keyFrames, Animation.PlayMode playMode) {
      this(frameDuration, keyFrames);
      this.setPlayMode(playMode);
   }

   public Animation(float frameDuration, Object... keyFrames) {
      this.frameDuration = frameDuration;
      this.setKeyFrames(keyFrames);
   }

   public Object getKeyFrame(float stateTime, boolean looping) {
      ...
      Object frame = (T)this.getKeyFrame(stateTime);
      this.playMode = oldPlayMode;
      return frame;
   }

   public Object getKeyFrame(float stateTime) {
   ...
   protected void setKeyFrames(Object... keyFrames) {
