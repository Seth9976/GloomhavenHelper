...
public class BitmapFont implements Disposable {
   ...
   public BitmapFont(BitmapFont.BitmapFontData data, Array pageRegions, boolean integer) {
   ...
   public static class BitmapFontData {
                     ...
                     if (line == null) {
                        ...
                        if (common.length < 3) {
                           ...
                           if (!common[2].startsWith("base=")) {
                              ...
                              for (int p = 0; p < pageCount; p++) {
                                 ...
                                 if (matcher.find()) {
                                    ...
                                    try {
                                       ...
                                       throw new GdxRuntimeException("Invalid page id: " + id, var36);
                                    }
                                 }
                              ...
                              while (true) {
                                 line = reader.readLine();
                                 if (line == null || line.startsWith("kernings ") || line.startsWith("metrics ")) {
         ...
         if (max != 0) {
            ...
            do {
               ...
               if (ch != '\r') {
                  ...
                  xAdvances.add(
                     lastGlyph == null
                        ? (glyph.fixedWidth ? 0.0F : -glyph.xoffset * scaleX - this.padLeft)
      ...
      public int getWrapIndex(Array glyphs, int start) {
         ...
         char ch = (char)((BitmapFont.Glyph)glyphsItems[i]).id;
         if (this.isWhitespace(ch)) {
            ...
            while (i > 0) {
               ch = (char)((BitmapFont.Glyph)glyphsItems[i]).id;
