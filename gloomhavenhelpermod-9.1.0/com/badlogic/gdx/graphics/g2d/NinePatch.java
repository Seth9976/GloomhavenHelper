...
public class NinePatch {
   ...
   public NinePatch(TextureRegion... patches) {
      if (patches != null && patches.length == 9) {
         this.load(patches);
         if ((patches[0] == null || patches[0].getRegionWidth() == this.leftWidth)
            && (patches[3] == null || patches[3].getRegionWidth() == this.leftWidth)
            && (patches[6] == null || patches[6].getRegionWidth() == this.leftWidth)) {
            if ((patches[2] == null || patches[2].getRegionWidth() == this.rightWidth)
               && (patches[5] == null || patches[5].getRegionWidth() == this.rightWidth)
               && (patches[8] == null || patches[8].getRegionWidth() == this.rightWidth)) {
               if ((patches[6] == null || patches[6].getRegionHeight() == this.bottomHeight)
                  && (patches[7] == null || patches[7].getRegionHeight() == this.bottomHeight)
                  && (patches[8] == null || patches[8].getRegionHeight() == this.bottomHeight)) {
                  if (patches[0] != null && patches[0].getRegionHeight() != this.topHeight
                     || patches[1] != null && patches[1].getRegionHeight() != this.topHeight
                     || patches[2] != null && patches[2].getRegionHeight() != this.topHeight) {
