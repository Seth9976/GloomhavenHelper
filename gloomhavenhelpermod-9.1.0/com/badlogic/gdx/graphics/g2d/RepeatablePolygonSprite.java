...
public class RepeatablePolygonSprite {
   ...
   private Array vertices = new Array();
   private Array indices = new Array();
   private int cols;
   private int rows;
   ...
   private void buildVertices() {
      ...
      for (int i = 0; i < this.parts.size; i++) {
         float[] verts = (float[])this.parts.get(i);
         if (verts != null) {
   ...
   public void draw(PolygonSpriteBatch batch) {
      ...
      for (int i = 0; i < this.vertices.size; i++) {
         batch.draw(
            ...
            (float[])this.vertices.get(i),
            0,
            ((float[])this.vertices.get(i)).length,
            (short[])this.indices.get(i),
            0,
            ((short[])this.indices.get(i)).length
         );
      }
   }
