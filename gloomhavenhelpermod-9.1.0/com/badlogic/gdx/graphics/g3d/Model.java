...
public class Model implements Disposable {
   ...
   protected void loadAnimations(Iterable modelAnimations) {
            ...
            if (node != null) {
               ...
               if (nanim.rotation != null) {
                  ...
                  for (ModelNodeKeyframe kf : nanim.rotation) {
                     ...
                     nodeAnim.rotation.add(new NodeKeyframe(kf.keytime, new Quaternion(kf.value == null ? node.rotation : (Quaternion)kf.value)));
                  }
               }
   ...
   protected void loadNodes(Iterable modelNodes) {
   ...
   protected void loadMeshes(Iterable meshes) {
   ...
   protected void loadMaterials(Iterable modelMaterials, TextureProvider textureProvider) {
