...
public abstract class Emitter extends ParticleControllerComponent implements Json.Serializable {
   ...
   public void read(Json json, JsonValue jsonData) {
      this.minParticleCount = (Integer)json.readValue("minParticleCount", int.class, jsonData);
      this.maxParticleCount = (Integer)json.readValue("maxParticleCount", int.class, jsonData);
   }
}
