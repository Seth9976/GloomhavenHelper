...
public class ScaledNumericValue extends RangedNumericValue {
   ...
   public void read(Json json, JsonValue jsonData) {
      ...
      this.highMin = (Float)json.readValue("highMin", float.class, jsonData);
      this.highMax = (Float)json.readValue("highMax", float.class, jsonData);
      this.relative = (Boolean)json.readValue("relative", boolean.class, jsonData);
