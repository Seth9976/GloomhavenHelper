   ...
   public void init(ShaderProgram program, Renderable renderable) {
      if (this.locations != null) {
         ...
         for (int i = 0; i < n; i++) {
            ...
            BaseShader.Validator validator = (BaseShader.Validator)this.validators.get(i);
            BaseShader.Setter setter = (BaseShader.Setter)this.setters.get(i);
   ...
   public void begin(Camera camera, RenderContext context) {
      ...
      for (int i = 0; i < this.globalUniforms.size; i++) {
         ...
         if (this.setters.get(u = this.globalUniforms.get(i)) != null) {
            ((BaseShader.Setter)this.setters.get(u)).set(this, u, null, null);
         }
      }
   }
   ...
   public void render(Renderable renderable, Attributes combinedAttributes) {
      for (int i = 0; i < this.localUniforms.size; i++) {
         ...
         if (this.setters.get(u = this.localUniforms.get(i)) != null) {
            ((BaseShader.Setter)this.setters.get(u)).set(this, u, renderable, combinedAttributes);
         }
      }
