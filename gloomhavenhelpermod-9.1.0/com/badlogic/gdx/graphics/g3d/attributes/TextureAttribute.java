...
public class TextureAttribute extends Attribute {
   ...
   public TextureAttribute(long type, TextureDescriptor textureDescription, float offsetU, float offsetV, float scaleU, float scaleV, int uvIndex) {
   ...
   public TextureAttribute(long type, TextureDescriptor textureDescription, float offsetU, float offsetV, float scaleU, float scaleV) {
