...
public class TextureDescriptor implements Comparable {
   ...
   public TextureDescriptor(
      GLTexture texture, Texture.TextureFilter minFilter, Texture.TextureFilter magFilter, Texture.TextureWrap uWrap, Texture.TextureWrap vWrap
   ) {
   ...
   public void set(GLTexture texture, Texture.TextureFilter minFilter, Texture.TextureFilter magFilter, Texture.TextureWrap uWrap, Texture.TextureWrap vWrap) {
