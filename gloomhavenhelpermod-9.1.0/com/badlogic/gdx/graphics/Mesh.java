...
public class Mesh implements Disposable {
   ...
   public Mesh enableInstancedRendering(boolean isStatic, int maxInstances, VertexAttribute... attributes) {
      if (!this.isInstanced) {
         ...
         throw new GdxRuntimeException(
            "Trying to enable InstancedRendering on same Mesh instance twice. Use disableInstancedRendering to clean up old InstanceData first"
         );
      }
   }
   ...
   private static void addManagedMesh(Application app, Mesh mesh) {
      Array managedResources = (Array<Mesh>)meshes.get(app);
   ...
   public static void invalidateAllMeshes(Application app) {
      Array meshesArray = (Array<Mesh>)meshes.get(app);
      if (meshesArray != null) {
