...
public class TextureArray extends GLTexture {
   ...
   private static void addManagedTexture(Application app, TextureArray texture) {
      Array managedTextureArray = (Array<TextureArray>)managedTextureArrays.get(app);
   ...
   public static void invalidateAllTextureArrays(Application app) {
      ...
      if (managedTextureArray != null) {
         for (int i = 0; i < managedTextureArray.size; i++) {
            TextureArray textureArray = (TextureArray)managedTextureArray.get(i);
            textureArray.reload();
         }
      }
   }
   ...
   public static String getManagedStatus() {
      ...
      for (Application app : managedTextureArrays.keySet()) {
         builder.append(((Array)managedTextureArrays.get(app)).size);
         builder.append(" ");
      }
   ...
   public static int getNumManagedTextureArrays() {
      return ((Array)managedTextureArrays.get(Gdx.app)).size;
   }
}
