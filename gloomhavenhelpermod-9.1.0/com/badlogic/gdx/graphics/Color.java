...
public class Color {
   ...
   public static Color valueOf(String hex, Color color) {
      ...
      color.r = Integer.parseInt(hex.substring(0, 2), 16) / 255.0F;
      color.g = Integer.parseInt(hex.substring(2, 4), 16) / 255.0F;
      color.b = Integer.parseInt(hex.substring(4, 6), 16) / 255.0F;
      color.a = hex.length() != 8 ? 1.0F : Integer.parseInt(hex.substring(6, 8), 16) / 255.0F;
      return color;
   }
