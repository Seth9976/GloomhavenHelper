...
public class InstanceBufferObjectSubData implements InstanceData {
   ...
   public void updateInstanceData(int targetOffset, float[] data, int sourceOffset, int count) {
      ...
      if (this.isDirect) {
         ...
         BufferUtils.copy(data, sourceOffset, count, this.byteBuffer);
         ...
         for (int i = 0; i < numAttributes; i++) {
            ...
            if (location >= 0) {
               ...
               shader.setVertexAttribute(
                  location + unitOffset, attribute.numComponents, attribute.type, attribute.normalized, this.attributes.vertexSize, attribute.offset
               );
