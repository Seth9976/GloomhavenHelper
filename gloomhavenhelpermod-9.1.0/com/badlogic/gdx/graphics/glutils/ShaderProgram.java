...
public class ShaderProgram implements Disposable {
   ...
   private void addManagedShader(Application app, ShaderProgram shaderProgram) {
      Array managedResources = (Array<ShaderProgram>)shaders.get(app);
   ...
   public static void invalidateAllShaderPrograms(Application app) {
      if (Gdx.gl20 != null) {
         Array shaderArray = (Array<ShaderProgram>)shaders.get(app);
         if (shaderArray != null) {
   ...
   public static String getManagedStatus() {
      ...
      for (Application app : shaders.keys()) {
         builder.append(((Array)shaders.get(app)).size);
         builder.append(" ");
      }
   ...
   public static int getNumManagedShaderPrograms() {
      return ((Array)shaders.get(Gdx.app)).size;
   }
