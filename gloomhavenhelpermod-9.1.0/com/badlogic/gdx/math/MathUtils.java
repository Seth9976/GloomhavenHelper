...
public final class MathUtils {
   ...
   public static float acos(float a) {
      ...
      float a3 = a * a2;
      return a >= 0.0F
         ? (float)Math.sqrt(1.0F - a) * (1.5707288F - 0.2121144F * a + 0.074261F * a2 - 0.0187293F * a3)
         : (float) Math.PI - (float)Math.sqrt(1.0F + a) * (1.5707288F + 0.2121144F * a + 0.074261F * a2 + 0.0187293F * a3);
   }
   ...
   public static float asin(float a) {
      ...
      float a3 = a * a2;
      return a >= 0.0F
         ? (float) (Math.PI / 2) - (float)Math.sqrt(1.0F - a) * (1.5707288F - 0.2121144F * a + 0.074261F * a2 - 0.0187293F * a3)
         : (float) (-Math.PI / 2) + (float)Math.sqrt(1.0F + a) * (1.5707288F + 0.2121144F * a + 0.074261F * a2 + 0.0187293F * a3);
   }
   ...
   public static long random(long start, long end) {
      ...
      long boundLow = bound & 4294967295L;
