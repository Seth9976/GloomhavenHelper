...
public class Matrix4 implements Serializable {
   ...
   public Matrix4 inv() {
      ...
      if (l_det == 0.0F) {
         ...
         float m00 = this.val[9] * this.val[14] * this.val[7]
         ...
         float m01 = this.val[12] * this.val[10] * this.val[7]
         ...
         float m02 = this.val[8] * this.val[13] * this.val[7]
         ...
         float m03 = this.val[12] * this.val[9] * this.val[6]
         ...
         float m10 = this.val[13] * this.val[10] * this.val[3]
         ...
         float m11 = this.val[8] * this.val[14] * this.val[3]
         ...
         float m12 = this.val[12] * this.val[9] * this.val[3]
         ...
         float m13 = this.val[8] * this.val[13] * this.val[2]
         ...
         float m20 = this.val[5] * this.val[14] * this.val[3]
         ...
         float m21 = this.val[12] * this.val[6] * this.val[3]
         ...
         float m22 = this.val[4] * this.val[13] * this.val[3]
         ...
         float m23 = this.val[12] * this.val[5] * this.val[2]
         ...
         float m30 = this.val[9] * this.val[6] * this.val[3]
         ...
         float m31 = this.val[4] * this.val[10] * this.val[3]
         ...
         float m32 = this.val[8] * this.val[5] * this.val[3]
         ...
         float m33 = this.val[4] * this.val[9] * this.val[2]
   ...
   public static boolean inv(float[] values) {
      ...
      if (l_det == 0.0F) {
         ...
         float m00 = values[9] * values[14] * values[7]
            - values[13] * values[10] * values[7]
            + values[13] * values[6] * values[11]
            - values[5] * values[14] * values[11]
            - values[9] * values[6] * values[15]
            + values[5] * values[10] * values[15];
         float m01 = values[12] * values[10] * values[7]
            - values[8] * values[14] * values[7]
            - values[12] * values[6] * values[11]
            + values[4] * values[14] * values[11]
            + values[8] * values[6] * values[15]
            - values[4] * values[10] * values[15];
         float m02 = values[8] * values[13] * values[7]
            - values[12] * values[9] * values[7]
            + values[12] * values[5] * values[11]
            - values[4] * values[13] * values[11]
            - values[8] * values[5] * values[15]
            + values[4] * values[9] * values[15];
         float m03 = values[12] * values[9] * values[6]
            - values[8] * values[13] * values[6]
            - values[12] * values[5] * values[10]
            + values[4] * values[13] * values[10]
            + values[8] * values[5] * values[14]
            - values[4] * values[9] * values[14];
         float m10 = values[13] * values[10] * values[3]
            - values[9] * values[14] * values[3]
            - values[13] * values[2] * values[11]
            + values[1] * values[14] * values[11]
            + values[9] * values[2] * values[15]
            - values[1] * values[10] * values[15];
         float m11 = values[8] * values[14] * values[3]
            - values[12] * values[10] * values[3]
            + values[12] * values[2] * values[11]
            - values[0] * values[14] * values[11]
            - values[8] * values[2] * values[15]
            + values[0] * values[10] * values[15];
         float m12 = values[12] * values[9] * values[3]
            - values[8] * values[13] * values[3]
            - values[12] * values[1] * values[11]
            + values[0] * values[13] * values[11]
            + values[8] * values[1] * values[15]
            - values[0] * values[9] * values[15];
         float m13 = values[8] * values[13] * values[2]
            - values[12] * values[9] * values[2]
            + values[12] * values[1] * values[10]
            - values[0] * values[13] * values[10]
            - values[8] * values[1] * values[14]
            + values[0] * values[9] * values[14];
         float m20 = values[5] * values[14] * values[3]
            - values[13] * values[6] * values[3]
            + values[13] * values[2] * values[7]
            - values[1] * values[14] * values[7]
            - values[5] * values[2] * values[15]
            + values[1] * values[6] * values[15];
         float m21 = values[12] * values[6] * values[3]
            - values[4] * values[14] * values[3]
            - values[12] * values[2] * values[7]
            + values[0] * values[14] * values[7]
            + values[4] * values[2] * values[15]
            - values[0] * values[6] * values[15];
         float m22 = values[4] * values[13] * values[3]
            - values[12] * values[5] * values[3]
            + values[12] * values[1] * values[7]
            - values[0] * values[13] * values[7]
            - values[4] * values[1] * values[15]
            + values[0] * values[5] * values[15];
         float m23 = values[12] * values[5] * values[2]
            - values[4] * values[13] * values[2]
            - values[12] * values[1] * values[6]
            + values[0] * values[13] * values[6]
            + values[4] * values[1] * values[14]
            - values[0] * values[5] * values[14];
         float m30 = values[9] * values[6] * values[3]
         ...
         float m33 = values[4] * values[9] * values[2]
   ...
   public static float det(float[] values) {
      return values[3] * values[6] * values[9] * values[12]
