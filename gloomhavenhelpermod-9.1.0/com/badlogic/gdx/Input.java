...
public interface Input {
   ...
   float getPressure(int var1);

   boolean isButtonPressed(int var1);

   boolean isButtonJustPressed(int var1);
   ...
   void getTextInput(Input.TextInputListener var1, String var2, String var3, String var4, Input.OnscreenKeyboardType var5);

   void setOnscreenKeyboardVisible(boolean var1);

   void setOnscreenKeyboardVisible(boolean var1, Input.OnscreenKeyboardType var2);
   ...
   void setCatchKey(int var1, boolean var2);

   boolean isCatchKey(int var1);
