...
class Lwjgl3GL20 implements GL20 {
   ...
   public String glGetActiveAttrib(int program, int index, IntBuffer size, IntBuffer type) {
      return org.lwjgl.opengl.GL20.glGetActiveAttrib(program, index, 256, size, type);
   }

   @Override
   public String glGetActiveUniform(int program, int index, IntBuffer size, IntBuffer type) {
      return org.lwjgl.opengl.GL20.glGetActiveUniform(program, index, 256, size, type);
   }
   ...
   public void glUniform1fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform1fv(location, v);
   }

   @Override
   public void glUniform1fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform1fv(location, this.toFloatBuffer(v, offset, count));
   }
   ...
   public void glUniform1iv(int location, int count, IntBuffer v) {
      org.lwjgl.opengl.GL20.glUniform1iv(location, v);
   }

   @Override
   public void glUniform1iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform1iv(location, this.toIntBuffer(v, offset, count));
   }
   ...
   public void glUniform2fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform2fv(location, v);
   }

   @Override
   public void glUniform2fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform2fv(location, this.toFloatBuffer(v, offset, count << 1));
   }
   ...
   public void glUniform2iv(int location, int count, IntBuffer v) {
      org.lwjgl.opengl.GL20.glUniform2iv(location, v);
   }

   @Override
   public void glUniform2iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform2iv(location, this.toIntBuffer(v, offset, count << 1));
   }
   ...
   public void glUniform3fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform3fv(location, v);
   }

   @Override
   public void glUniform3fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform3fv(location, this.toFloatBuffer(v, offset, count * 3));
   }
   ...
   public void glUniform3iv(int location, int count, IntBuffer v) {
      org.lwjgl.opengl.GL20.glUniform3iv(location, v);
   }

   @Override
   public void glUniform3iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform3iv(location, this.toIntBuffer(v, offset, count * 3));
   }
   ...
   public void glUniform4fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform4fv(location, v);
   }

   @Override
   public void glUniform4fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform4fv(location, this.toFloatBuffer(v, offset, count << 2));
   }
   ...
   public void glUniform4iv(int location, int count, IntBuffer v) {
      org.lwjgl.opengl.GL20.glUniform4iv(location, v);
   }

   @Override
   public void glUniform4iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform4iv(location, this.toIntBuffer(v, offset, count << 2));
   }
   ...
   public void glUniformMatrix2fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix2fv(location, transpose, this.toFloatBuffer(value, offset, count << 2));
   }
   ...
   public void glUniformMatrix3fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix3fv(location, transpose, this.toFloatBuffer(value, offset, count * 9));
   }
   ...
   public void glUniformMatrix4fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix4fv(location, transpose, this.toFloatBuffer(value, offset, count << 4));
   }
   ...
   public void glVertexAttribPointer(int indx, int size, int type, boolean normalized, int stride, Buffer buffer) {
      if (buffer instanceof ByteBuffer) {
         if (type == 5120) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, (ByteBuffer)buffer);
         } else if (type == 5121) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, (ByteBuffer)buffer);
         } else if (type == 5122) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, ((ByteBuffer)buffer).asShortBuffer());
         } else if (type == 5123) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, ((ByteBuffer)buffer).asShortBuffer());
         } else {
            if (type != 5126) {
            ...
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, ((ByteBuffer)buffer).asFloatBuffer());
         }
      } else {
         ...
         org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, type, normalized, stride, (FloatBuffer)buffer);
      }
   }
