...
public class Base {
    ...
    public static final int kNumFullDistances = 0x80;
    public static final int kNumHighLenBits = 8;
    public static final int kNumLenSymbols = 0x110;
    ...
    public static final int GetLenToPosState(int v) [...] // 潜在的解密器

    public static final int StateInit() [...] // Inlined contents

    public static final boolean StateIsCharState(int v) {
        return v < 7;
    }

    public static final int StateUpdateChar(int v) {
        if(v < 4) {
            return 0;
        }
        return v >= 10 ? v - 6 : v - 3;
    ...
    public static final int StateUpdateMatch(int v) {
        return v < 7 ? 7 : 10;
    }

    public static final int StateUpdateRep(int v) {
        return v >= 7 ? 11 : 8;
    }

    public static final int StateUpdateShortRep(int v) {
        return v >= 7 ? 11 : 9;
    }
}
