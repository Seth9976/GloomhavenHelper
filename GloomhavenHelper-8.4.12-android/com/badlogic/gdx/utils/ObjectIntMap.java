...
public class ObjectIntMap implements Iterable {
    public static class Entries extends MapIterator implements Iterable, Iterator {
        ...
        public Entries(ObjectIntMap objectIntMap0) {
            super(objectIntMap0);
    ...
    public static class Keys extends MapIterator implements Iterable, Iterator {
        public Keys(ObjectIntMap objectIntMap0) {
            super(objectIntMap0);
        }
    ...
    static class MapIterator {
        ...
        public MapIterator(ObjectIntMap objectIntMap0) {
            this.valid = true;
            this.map = objectIntMap0;
            this.reset();
        }
    ...
    public static class Values extends MapIterator {
        public Values(ObjectIntMap objectIntMap0) {
            super(objectIntMap0);
        }
        ...
        public int next() {
            ...
            int v = this.map.valueTable[this.nextIndex];
            this.currentIndex = this.nextIndex;
            this.findNextIndex();
            return v;
        }
    ...
    public ObjectIntMap(int v) {
        this(v, 0.8f);
    }

    public ObjectIntMap(int v, float f) {
        if(f <= 0.0f || f >= 1.0f) {
    ...
    public ObjectIntMap(ObjectIntMap objectIntMap0) {
        this(((int)(((float)objectIntMap0.keyTable.length) * objectIntMap0.loadFactor)), objectIntMap0.loadFactor);
        System.arraycopy(objectIntMap0.keyTable, 0, this.keyTable, 0, objectIntMap0.keyTable.length);
        System.arraycopy(objectIntMap0.valueTable, 0, this.valueTable, 0, objectIntMap0.valueTable.length);
        this.size = objectIntMap0.size;
    }
    ...
    public boolean equals(Object object0) {
        ...
        if(((ObjectIntMap)object0).size != this.size) {
            return false;
        }
        Object[] arr_object = this.keyTable;
        int[] arr_v = this.valueTable;
        for(int v = 0; v < arr_object.length; ++v) {
            ...
            if(object1 != null) {
                int v1 = ((ObjectIntMap)object0).get(object1, 0);
                if(v1 == 0 && !((ObjectIntMap)object0).containsKey(object1)) {
                    return false;
                }
                if(v1 != arr_v[v]) {
                    return false;
    ...
    public int get(Object object0, int v) {
        int v1 = this.locateKey(object0);
        return v1 < 0 ? v : this.valueTable[v1];
    }

    public int getAndIncrement(Object object0, int v, int v1) {
    ...
    public int put(Object object0, int v, int v1) {
        int v2 = this.locateKey(object0);
        if(v2 >= 0) {
            int[] arr_v = this.valueTable;
            int v3 = arr_v[v2];
    ...
    public void put(Object object0, int v) {
        int v1 = this.locateKey(object0);
        if(v1 >= 0) {
    ...
    public void putAll(ObjectIntMap objectIntMap0) {
        this.ensureCapacity(objectIntMap0.size);
        Object[] arr_object = objectIntMap0.keyTable;
        int[] arr_v = objectIntMap0.valueTable;
        for(int v = 0; v < arr_object.length; ++v) {
    ...
    private void putResize(Object object0, int v) {
        Object[] arr_object = this.keyTable;
        int v1;
    ...
    public int remove(Object object0, int v) {
        int v1 = this.locateKey(object0);
        if(v1 < 0) {
            return v;
        }
