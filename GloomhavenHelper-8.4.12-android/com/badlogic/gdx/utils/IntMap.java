...
public class IntMap implements Iterable {
    ...
    static class MapIterator {
        ...
        public MapIterator(IntMap intMap0) {
            this.valid = true;
            this.map = intMap0;
            this.reset();
        }
    ...
    public IntMap(IntMap intMap0) {
        this(((int)(((float)intMap0.keyTable.length) * intMap0.loadFactor)), intMap0.loadFactor);
        System.arraycopy(intMap0.keyTable, 0, this.keyTable, 0, intMap0.keyTable.length);
        System.arraycopy(intMap0.valueTable, 0, this.valueTable, 0, intMap0.valueTable.length);
        this.size = intMap0.size;
        this.zeroValue = intMap0.zeroValue;
        this.hasZeroValue = intMap0.hasZeroValue;
    }
    ...
    public boolean containsValue(@Null Object object0, boolean z) {
        ...
        if(object0 == null) {
            ...
            for(int v = arr_object.length - 1; v >= 0; --v) {
                if(arr_v[v] != 0 && arr_object[v] == null) {
                    return true;
                }
            }
            return false;
    ...
    public boolean equals(Object object0) {
        ...
        if(((IntMap)object0).size != this.size) {
            return false;
        }
        boolean z = this.hasZeroValue;
        if(((IntMap)object0).hasZeroValue != z) {
            return false;
        }
        if(z) {
            Object object1 = ((IntMap)object0).zeroValue;
            if(object1 == null) {
        ...
        for(int v = 0; v < arr_v.length; ++v) {
            ...
            if(v1 != 0) {
                ...
                if(object2 == null) {
                    if(((IntMap)object0).get(v1, ObjectMap.dummy) != null) {
                        return false;
                    }
                }
                else if(!object2.equals(((IntMap)object0).get(v1))) {
                    return false;
                }
            }
        }
    ...
    public boolean equalsIdentity(@Null Object object0) {
        ...
        if(z && this.zeroValue != ((IntMap)object0).zeroValue) {
            return false;
        }
        int[] arr_v = this.keyTable;
        Object[] arr_object = this.valueTable;
        for(int v = 0; v < arr_v.length; ++v) {
            int v1 = arr_v[v];
            if(v1 != 0 && arr_object[v] != ((IntMap)object0).get(v1, ObjectMap.dummy)) {
                return false;
            }
        }
        return true;
    ...
    public int findKey(@Null Object object0, boolean z, int v) {
        Object[] arr_object = this.valueTable;
        if(object0 == null) {
            if(this.hasZeroValue && this.zeroValue == null) {
                return 0;
            ...
            int[] arr_v = this.keyTable;
            for(int v1 = arr_object.length - 1; v1 >= 0; --v1) {
                if(arr_v[v1] != 0 && arr_object[v1] == null) {
                    return arr_v[v1];
                }
            }
            return v;
    ...
    public Object get(int v, @Null Object object0) {
        if(v == 0) {
    ...
    @Null
    public Object put(int v, @Null Object object0) {
        if(v == 0) {
    ...
    public void putAll(IntMap intMap0) {
        this.ensureCapacity(intMap0.size);
        if(intMap0.hasZeroValue) {
            this.put(0, intMap0.zeroValue);
        }
        int[] arr_v = intMap0.keyTable;
        Object[] arr_object = intMap0.valueTable;
        for(int v = 0; v < arr_v.length; ++v) {
            int v1 = arr_v[v];
            if(v1 != 0) {
    ...
    private void putResize(int v, @Null Object object0) {
        int[] arr_v = this.keyTable;
        int v1;
