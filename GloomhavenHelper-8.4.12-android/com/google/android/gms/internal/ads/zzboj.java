...
public final class zzboj implements zzeej {
    private final zzbog zzfja;
    private final zzeew zzfjb;

    private zzboj(zzbog zzbog0, zzeew zzeew0) {
        this.zzfja = zzbog0;
        this.zzfjb = zzeew0;
    }
    ...
    public static zzboj zzb(zzbog zzbog0, zzeew zzeew0) {
        return new zzboj(zzbog0, zzeew0);
    }
}
