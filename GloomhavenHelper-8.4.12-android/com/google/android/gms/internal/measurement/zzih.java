...
final class zzih extends zzie {
        ...
        while(true) {
            ...
            if(v4 < 0) {
                if(v4 < 0xFFFFFFE0) {
                    ...
                    int v6 = arr_b[v3];
                    if(v6 <= -65 && (v4 << 28) + (v6 + 0x70) >> 30 == 0 && arr_b[v3 + 1] <= -65 && arr_b[v3 + 2] <= -65) {
                        v1 = v3 + 3;
                        continue;
                    }
                }
    ...
    final String zzb(byte[] arr_b, int v, int v1) throws zzfn {
        ...
        while(v < v2) {
            ...
            if(zzif.zze(((byte)v7))) {
                if(v6 < v2) {
                    zzif.zzb(((byte)v7), arr_b[v6], arr_c, v5);
                    v = v6 + 1;
                    ++v5;
                    continue;
                }
                ...
                if(v6 < v2 - 2) {
                    zzif.zzb(((byte)v7), arr_b[v6], arr_b[v6 + 1], arr_b[v6 + 2], arr_c, v5);
                    v = v6 + 3;
                    v5 += 2;
                    continue;
                }
                ...
                zzif.zzb(((byte)v7), arr_b[v6], arr_b[v6 + 1], arr_c, v5);
                v = v6 + 2;
                ++v5;
                continue;
            }
