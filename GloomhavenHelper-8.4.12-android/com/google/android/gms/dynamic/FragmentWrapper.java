...
public final class FragmentWrapper extends Stub {
    ...
    public final void startActivity(Intent intent0) {
        this.zzia.startActivity(intent0);
    }

    @Override  // com.google.android.gms.dynamic.IFragmentWrapper
    public final void startActivityForResult(Intent intent0, int v) {
        this.zzia.startActivityForResult(intent0, v);
    }
    ...
    public final void zza(IObjectWrapper iObjectWrapper0) {
        ...
        this.zzia.registerForContextMenu(view0);
    }
    ...
    public final IFragmentWrapper zzaf() {
        return FragmentWrapper.wrap(this.zzia.getParentFragment());
    }
    ...
    public final IFragmentWrapper zzah() {
        return FragmentWrapper.wrap(this.zzia.getTargetFragment());
    }
    ...
    public final void zzb(IObjectWrapper iObjectWrapper0) {
        View view0 = (View)ObjectWrapper.unwrap(iObjectWrapper0);
        this.zzia.unregisterForContextMenu(view0);
    }
}
